...
callback(undefined, body.current.weather_descriptions[0] + " it is currently " + body.current.temperature + "degress out,there is a " + body.current.feelslike + "degres out,humidity is" + body.current.humidity )
  }
})
}
